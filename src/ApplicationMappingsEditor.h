...
class ApplicationMappingsEditor : public Component, public Button::Listener
{
  public:
    ///	Constructor.
...
private :
    ...
    class MappingItem : public TreeViewItem
    {
      ...
      private:
        ...
        class MappingItemButtons : public Component, public Button::Listener, public KeyListener
        {
          public:
            ///	Constructor.
                ...
                : id(commandId), appManager(app), midiManager(midi), oscManager(osc)
            {
                ...
                std::unique_ptr<Drawable> addImage(JuceHelperStuff::loadSVGFromMemory(
                    Vectors::addmappingbutton_svg, Vectors::addmappingbutton_svgSize));
                std::unique_ptr<Drawable> addImageOver(JuceHelperStuff::loadSVGFromMemory(
                    Vectors::addmappingbuttonover_svg, Vectors::addmappingbuttonover_svgSize));
                addMapping = new DrawableButton("Add Mapping Buttton", DrawableButton::ImageFitted);
            ...
            ///	Destructor.
            ~MappingItemButtons() { deleteAllChildren(); };
