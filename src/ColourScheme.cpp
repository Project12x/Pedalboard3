...
bool ColourScheme::loadBuiltInPreset(const String& name)
{
    ...
    else if (name == "Daylight")
    {
        ...
        colours["Window Background"] = Colour(0xFFDDE5EA);
        colours["Field Background"] = Colour(0xFFE3EBF0);
        colours["Text Colour"] = Colour(0xFF030A10);
        colours["Plugin Border"] = Colour(0xFF748390);
        colours["Plugin Background"] = Colour(0xFFD0DAE2);
        colours["Audio Connection"] = Colour(0xFF0077CC);
        colours["Parameter Connection"] = Colour(0xFFB96312);
        colours["Button Colour"] = Colour(0xFFCFD9E1);
        colours["Button Highlight"] = Colour(0xFFE6EDF1);
        colours["Text Editor Colour"] = Colour(0xFFE8EFF3);
        ...
        colours["Dialog Inner Background"] = Colour(0xFFD5DEE6);
        colours["Slider Colour"] = Colour(0xFF0077CC);
        colours["List Selected Colour"] = Colour(0xFFB7D3E6);
        ...
        colours["Vector Colour"] = Colour(0x73030A10);
        ...
        colours["Stage Background Top"] = Colour(0xFFDDE5EA);
        colours["Stage Background Bottom"] = Colour(0xFFC8D2DB);
        colours["Stage Panel Background"] = Colour(0xFFC3CDD7);
        colours["Dialog Background"] = Colour(0xFFD8E1E8);
