...
bool ColourScheme::loadBuiltInPreset(const String& name)
{
    ...
    else if (name == "Daylight")
    {
        ...
        colours["Window Background"] = Colour(0xFFE7EBEF);
        colours["Field Background"] = Colour(0xFFEAF0F3);
        colours["Text Colour"] = Colour(0xFF172028);
        colours["Plugin Border"] = Colour(0xFF98A5AF);
        colours["Plugin Background"] = Colour(0xFFDCE3E8);
        colours["Audio Connection"] = Colour(0xFF0077CC);
        colours["Parameter Connection"] = Colour(0xFFB96312);
        colours["Button Colour"] = Colour(0xFFDDE4E9);
        colours["Button Highlight"] = Colour(0xFFECEFF2);
        colours["Text Editor Colour"] = Colour(0xFFE5EBEF);
        ...
        colours["Dialog Inner Background"] = Colour(0xFFE1E7EC);
        colours["Slider Colour"] = Colour(0xFF0077CC);
        colours["List Selected Colour"] = Colour(0xFFC7DDEC);
        ...
        colours["Stage Background Top"] = Colour(0xFFE7EBEF);
        colours["Stage Background Bottom"] = Colour(0xFFD0D6DC);
        colours["Stage Panel Background"] = Colour(0xFFC7CED5);
        colours["Dialog Background"] = Colour(0xFFDFE6EB);
