                               ...
                               public Value::Listener // JUCE 8: Value::Listener (was ValueListener)
{
  public:
    ...
    */
    explicit MappingSlider(const String& componentName = String()); // JUCE 8: String() instead of String::empty
    ...
    */
    enum ColourIds
    {
        ...
        rotaryMappingSliderFillColourId = 0x1001311,    /**< For rotary sliders, this colour fills the outer curve.
                                                         */
        rotaryMappingSliderOutlineColourId = 0x1001312, /**< For rotary sliders, this colour is used to draw the
                                                           outer curve's outline. */

        textBoxTextColourId = 0x1001400,       /**< The colour for the text in the text-editor box used for
                                                  editing the value. */
  ...
  private:
    ...
    friend class std::unique_ptr<PopupDisplayComponent>;
