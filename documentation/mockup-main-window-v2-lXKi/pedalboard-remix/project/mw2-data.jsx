...
function m2InitialGraph() {
  ...
  const amp = push({ id: "fx_amp", type: "plugin", cat: "amp", name: "NAM Loader",
    model: "Friedman BE-100", arch: "WaveNet", author: "Mesa Tone Lab", rating: 4.8, cpu: 4.6, x: 520, y: 150, w: 304,
    ...
    eqMode: false,
    eq: [
      { type: "ls",   freq: 120,  gain: 2.5,  q: 0.7, color: "#38bdf8" },
      { type: "bell", freq: 520,  gain: -3,   q: 1.4, color: "#fbbf24" },
      { type: "bell", freq: 2400, gain: 4,    q: 1.1, color: "#c084fc" },
      { type: "hs",   freq: 7200, gain: -1.5, q: 0.7, color: "#ff6b6b" },
    ],
...
function m2MakeNode(entry, x, y) {
  ...
  if (entry.cat === "amp" || entry.name === "NAM Loader") return { ...base, type: "plugin", w: 304,
    model: "No Model", arch: "WaveNet", author: "—", rating: 0, ir1: null, ir2: null,
    lo: "80 Hz", hi: "12.0 kHz", blend: 0,
    gain: [["Input", "0.0", 0.5], ["Output", "0.0", 0.5], ["Gate", "-80", 0.08]],
    tone: [["Bass", 0.5], ["Mid", 0.5], ["Treble", 0.5]],
    eqMode: false,
    eq: [
      { type: "ls",   freq: 120,  gain: 0, q: 0.7, color: "#38bdf8" },
      { type: "bell", freq: 520,  gain: 0, q: 1.4, color: "#fbbf24" },
      { type: "bell", freq: 2400, gain: 0, q: 1.1, color: "#c084fc" },
      { type: "hs",   freq: 7200, gain: 0, q: 0.7, color: "#ff6b6b" },
    ],
